...
exports.MedicalFacilityFetchContext = void 0;
const HttpResponse_1 = __importDefault(require("../utils/HttpResponse"));
class MedicalFacilityFetchContext {
    constructor(strategy) {
        this.strategy = strategy;
    }
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const medicalFacility = yield this.strategy.fetch(req);
            const data = HttpResponse_1.default.Ok(medicalFacility);
            res.status(data.statusCode).json(data);
        });
    }
}
exports.MedicalFacilityFetchContext = MedicalFacilityFetchContext;
/*
