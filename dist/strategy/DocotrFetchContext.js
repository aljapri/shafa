...
class DocotrFetchContext {
    ...
    handle(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const doctors = yield this.strategy.fetch(req);
                const data = HttpResponse_1.default.Ok(doctors);
...
exports.DocotrFetchContext = DocotrFetchContext;
/*
