...
exports.AppointmentFetchContext = void 0;
const HttpResponse_1 = __importDefault(require("../utils/HttpResponse"));
class AppointmentFetchContext {
    ...
    handle(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const appointment = yield this.strategy.fetch(req);
                const data = HttpResponse_1.default.Ok(appointment);
...
exports.AppointmentFetchContext = AppointmentFetchContext;
/*
