...
class PatientLoginHandler extends AccountLoaginBase_service_1.default {
    constructor() {
        super();
    }
    handle(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const account = yield Patient_model_1.Patient.findOne({ auth: auth._id }).populate("auth", "email ").select("-createdAt -updatedAt ");
            // Generate JWT token
...
exports.default = PatientLoginHandler;
